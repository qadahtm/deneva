...
//    DEBUG_WL("YCSBQuery: %ld-%d %ld-%d %ld-%d %ld-%d %ld-%d %ld-%d %ld-%d %ld-%d %ld-%d %ld-%d\n"
//                     ,((YCSBQuery*)query)->requests[0]->key, ((YCSBWorkload *) h_wl)->key_to_part(((YCSBQuery*)query)->requests[0]->key)
//                     ,((YCSBQuery*)query)->requests[1]->key, ((YCSBWorkload *) h_wl)->key_to_part(((YCSBQuery*)query)->requests[1]->key)
//                     ,((YCSBQuery*)query)->requests[2]->key, ((YCSBWorkload *) h_wl)->key_to_part(((YCSBQuery*)query)->requests[2]->key)
//                     ,((YCSBQuery*)query)->requests[3]->key, ((YCSBWorkload *) h_wl)->key_to_part(((YCSBQuery*)query)->requests[3]->key)
//                     ,((YCSBQuery*)query)->requests[4]->key, ((YCSBWorkload *) h_wl)->key_to_part(((YCSBQuery*)query)->requests[4]->key)
//                     ,((YCSBQuery*)query)->requests[5]->key, ((YCSBWorkload *) h_wl)->key_to_part(((YCSBQuery*)query)->requests[5]->key)
//                     ,((YCSBQuery*)query)->requests[6]->key, ((YCSBWorkload *) h_wl)->key_to_part(((YCSBQuery*)query)->requests[6]->key)
//                     ,((YCSBQuery*)query)->requests[7]->key, ((YCSBWorkload *) h_wl)->key_to_part(((YCSBQuery*)query)->requests[7]->key)
//                     ,((YCSBQuery*)query)->requests[8]->key, ((YCSBWorkload *) h_wl)->key_to_part(((YCSBQuery*)query)->requests[8]->key)
//                     ,((YCSBQuery*)query)->requests[9]->key, ((YCSBWorkload *) h_wl)->key_to_part(((YCSBQuery*)query)->requests[9]->key)
//             );
    return query;
}
        ...
        if (FIRST_PART_LOCAL && rid == 0) {
            if (hot < g_access_perc) {
                ...
                row_id = ((nrand % (g_synth_table_size / g_part_cnt - (hot_key_max / g_part_cnt))) +
                          hot_key_max / g_part_cnt) * g_part_cnt + home_partition_id;
            }
...
//    DEBUG_WL("YCSBQuery: %d %d %d %d %d %d %d %d %d %d\n"
//            ,((YCSBWorkload *) h_wl)->key_to_part(query->requests[0]->key)
//            ,((YCSBWorkload *) h_wl)->key_to_part(query->requests[1]->key)
//            ,((YCSBWorkload *) h_wl)->key_to_part(query->requests[2]->key)
//            ,((YCSBWorkload *) h_wl)->key_to_part(query->requests[3]->key)
//            ,((YCSBWorkload *) h_wl)->key_to_part(query->requests[4]->key)
//            ,((YCSBWorkload *) h_wl)->key_to_part(query->requests[5]->key)
//            ,((YCSBWorkload *) h_wl)->key_to_part(query->requests[6]->key)
//            ,((YCSBWorkload *) h_wl)->key_to_part(query->requests[7]->key)
//            ,((YCSBWorkload *) h_wl)->key_to_part(query->requests[8]->key)
//            ,((YCSBWorkload *) h_wl)->key_to_part(query->requests[9]->key)
//    );
    query->print();
    return query;
