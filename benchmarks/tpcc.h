...
public:
    ...
    RC plan_payment_update_w(TPCCClientQueryMessage *tpcc_msg, exec_queue_entry *entry);
    ...
    RC plan_payment_update_d(TPCCClientQueryMessage *tpcc_msg, exec_queue_entry *entry);
    ...
    RC plan_payment_update_c(TPCCClientQueryMessage *tpcc_msg, exec_queue_entry *entry);
    ...
    RC plan_payment_insert_h(TPCCClientQueryMessage *tpcc_msg, exec_queue_entry *entry);
    ...
    RC plan_neworder_read_w(TPCCClientQueryMessage *tpcc_msg, exec_queue_entry *entry);
    ...
    RC plan_neworder_read_c(TPCCClientQueryMessage *tpcc_msg, exec_queue_entry *entry);
    ...
    RC plan_neworder_update_d(TPCCClientQueryMessage *tpcc_msg, exec_queue_entry *entry);

    RC run_neworder_update_d(exec_queue_entry * entry);
    ...
    RC plan_neworder_insert_o(TPCCClientQueryMessage *tpcc_msg, exec_queue_entry *entry);
    ...
    RC plan_neworder_insert_no(TPCCClientQueryMessage *tpcc_msg, exec_queue_entry *entry);
