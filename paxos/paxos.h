...
// The above authors are the original authors of paxos.cc
...
public:
    ...
    Paxos(const string &zookeeper_config_file, bool reader, const string &rootPath);

    Paxos(const string &zookeeper_config_file, bool reader, const string &rootPath, bool traceNodeCreation);
    ...
    /**
     * Used to clean up Root path on Zookeeper.
     */
    void cleanUpRoot();
...
private:
    // rootPath
    string rootPath;
    string batchPathPrefix;
    bool traceNodeCreation = false;

    void init(const string &zookeeper_config_file, bool reader, const string &rootPath, bool traceNodeCreation);
